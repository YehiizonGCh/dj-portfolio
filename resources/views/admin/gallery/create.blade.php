...
@section('content')
    ...
    <div class="flex items-center gap-3 mb-8">
        ...
        <h1 class="text-2xl font-bold text-white">Subir Archivo</h1>
    </div>
    ...
    <div class="bg-white/5 rounded-xl border border-white/5 p-6 max-w-2xl">
        ...
        <form method="POST" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-widest mb-1.5">Archivo</label>
                    ...
                    <p class="text-xs text-gray-600 mt-1">Fotos: jpg, png, webp — Videos: mp4, mov (máx. 50MB)</p>
                </div>

                <div class="sm:col-span-2">
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-widest mb-1.5">Miniaturas (solo videos)</label>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="caption" rows="2"
                              class="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-cyan-400">{{ old('caption') }}</textarea>
                </div>
